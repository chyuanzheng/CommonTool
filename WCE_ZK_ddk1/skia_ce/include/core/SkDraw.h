...
public:
	...
	void    drawPathToPath(const SkPath& origSrcPath, const SkPaint& paint,
	...
	bool    getPath(const char text[], size_t byteLength, SkScalar x,
...
private:
	...
	void    drawText_toPaths(const char text[], size_t byteLength,
		SkScalar x, SkScalar y, const SkPaint&, std::vector<SkPath> &path) const;
