...
// USER MESSAGE ID
#define WM_UI_MESSAGE_BASE		(WM_APP+100)

#define WM_CMDCTRL_MSGBASE	(WM_APP+200)

#define WM_EVENTCTRL_MSGBASE	(WM_APP+300)

#define WM_IPODAUDIO_MSGBASE		(WM_APP+400)

#define WM_IPOD_EX_MSGBASE  (WM_APP+500)
typedef enum{
	...
	WM_UI_UPDATE_PLAYING,
	WM_UI_UPDATE_PAUSE,
	WM_UI_UPDATE_SHUFFLE,
	WM_UI_UPDATE_REPEAT,
	WM_UI_UPDATE_NONE,
...
typedef enum{
	...
	WM_CMDCTRL_BRWS_INIT,
	WM_CMDCTRL_BRWS_RES_INIT,
	WM_CMDCTRL_BRWS_SELECTALL,
	WM_CMDCTRL_BRWS_RES_SELECTALL,
	WM_CMDCTRL_BRWS_SELECT,
	WM_CMDCTRL_BRWS_RES_SELECT,
	WM_CMDCTRL_BRWS_MOVEUPPER,
	WM_CMDCTRL_BRWS_RES_MOVEUPPER,
	WM_CMDCTRL_BRWS_GETNAME,
	WM_CMDCTRL_BRWS_RES_GETNAME,
	WM_CMDCTRL_BRWS_VIDEO_INIT,
...
// 
#define UI_MAX_STRING_LEN	(512)
#define IPOD_I2C_CH (1)
