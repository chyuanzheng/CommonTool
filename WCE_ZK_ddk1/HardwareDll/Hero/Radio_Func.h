...
extern U8 Hero_Radio_AM_Parameters[CONFIG_PARA_LEN];
extern const U8 Hero_Radio_AM_DefParameters[CONFIG_PARA_LEN];
extern U8 Hero_Radio_FM_Parameters[CONFIG_PARA_LEN];
extern const U8 Hero_Radio_FM_DefParameters[CONFIG_PARA_LEN];
/*---------------------------------------------------------------------------------
function define start
----------------------------------------------------------------------------------*/

/*band function*/
extern void CE_HardwareDll_API Radio_SetBand(U8 Band);
...
extern void CE_HardwareDll_API Radio_SetFreq(U8 mode,U8 Band,U16 Freq);
...
extern void  Radio_AM_Para_Write(void);
extern void  Radio_FM_Para_Write(void);

/*check station */
extern void Radio_CheckStation(void);
extern void Radio_CheckStationInit(void);
extern U8 Radio_CheckStationStatus(void);
extern U8 CE_HardwareDll_API Radio_HasStation(void);
