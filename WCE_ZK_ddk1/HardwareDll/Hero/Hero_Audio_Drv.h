...
#define HERO_VER_V1C03   0
#define HERO_VER_V1C05   1

/*keycode manager*/
#define POLYCHIME_KEYCODE  1
#define ULTRABASS_KEYCODE  1
#define ALE_KEYCODE  1
#define GEQ_9BAND_KEYCODE  1
#define AM_PACS_KEYCODE  1
#define WBAND_KEYCODE  0
#define FM_CES_KEYCODE  1
#define FM_SCANNING_KEYCODE  1


#define AUDIO_API_ENABLE  0
#define GEQ_9BAND_ENABLE  0
...
/*---------------audio channel define-------------------------*/
#define Audio_PFLCHANNEL 0x0001   //front left channel     
#define Audio_PFRCHANNEL 0x0002	//front right channel
#define Audio_PRLCHANNEL 0x0004	//rear left channel
#define Audio_PRRCHANNEL 0x0008	//rear right channel
#define Audio_SWLCHANNEL 0x0010	//subwoofer left channel
#define Audio_SWRCHANNEL 0x0020	//subwoofer right channel
#define Audio_SLCHANNEL 0x0040	//secondary left channel
#define Audio_SRCHANNEL 0x0080	//secondary right channel
#define Audio_PCHANNEL 0x0100		 //overall primary channel
#define Audio_SCHANNEL 0x0200		//overall secondary channel
#define Audio_NCHANNEL 0x0400		//overall navigation channel
#define Audio_TCHANNEL 0x0800		//overall phone channel
...
extern void Hero_EasyProgrammWrite(U32 Data);
...
extern U8 Audio_DrvSetI2SOutMode(U8 ADNum, U8 Mode);
...
extern void Audio_DrvGEQ9Band_Disable(void);
extern void Audio_DrvGEQ9Band_Enable(void);
/*source scaling*/
...
/*UltraBass*/
extern S8 Audio_DrvUltraBassDisable(void);
extern S8 Audio_DrvUltraBassEnable(void);
extern void Audio_DrvUltraBassSetEnhanceGain(S8 gain);

/*ALE*/
extern S8 Audio_DrvALEDisable(void);
extern S8 Audio_DrvALEEnable(void);
